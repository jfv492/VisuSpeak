      ...
      <div className="container">
        <div class="row about-grid">
          <div class="col-sm-6 large-text-style">
            ...
            significant communication gap between ASL users and those who speak
            or understand English primarily. This gap can lead to
            misunderstandings, limited opportunities, and exclusion for ASL
            users in various areas, such as education, employment, healthcare,
          ...
          <div className="col-sm-6 p-2 large-text-style">
            ...
            special accessibility needs to communicate effectively with others
            and gain access to essential services and information.
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="row">
          <div className="col-sm p-2 large-text-style">
            ...
            interactions, options to save and view different conversations, and
            a resource section to allow you to expand upon your American Sign
            ...
            can increase accessibility within your customer facing interactions
        ...
        <div className="row mt-2 resources-grid">
          <div className="col p-2 card my-5 resources-grid-item">
            <div class="card-body">
              ...
              <p class="card-text py-3 large-text-style">
                VisuSpeak will convert American Sign Language (ASL) gestures
                (from visual signing captured in a video clip) into text and
                audio to facilitate communication with English speakers.
              </p>
            </div>
          </div>
          ...
          <div className="col p-2 card my-5 resources-grid-item">
            <div class="card-body">
              ...
              <p class="card-text py-5 large-text-style">
                ...
                allow users to test the accuracy of their ASL by comparing it to
          ...
          <div className="col p-2 card my-5 resources-grid-item">
            <div class="card-body">
              ...
              <p class="card-text py-3 large-text-style">
                Users of the application can specify their accessibility needs,
                such as visual, vocal, and hearing impairments for a tailored
          ...
          <div className="col p-2 card mb-5 resources-grid-item">
            <div class="card-body">
              ...
              <p class="card-text py-5 large-text-style">
                Accessibility officers will have access to user transcripts,
                aiding in support and assistance.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container">
        <div className="row resources-grid">
          <div className="col p-2 mb-5">
            <p class="card-text py-3 large-text-style">
              For more information on VisuSpeak and the development journey on
              this product, please visit our GitHub Repository. If you would
              rather watch the progression updates, then please visit our
              YouTube channel.
            </p>
          </div>
          ...
          <div className="col p-2 mb-5 text-center">
            <a
              class="hyperlink hyperlink:hover"
