...
export default function Login(props) {
  ...
  const startNewChatSession = async () => {
    try {
      // This should hit the endpoint that creates a new chat session
          ...
          <div class="container text-center">
            <div class="row justify-content-center">
              <div class="col-sm-4 chat-buttons d-flex flex-column">
                  ...
                  >
                    <i class="fa-solid fa-message fa-xl me-4" style={{color: "#ffffff"}}></i>
                    Start New Chat
                  </Link>
                  <Link
                    to="/history"
                    ...
                    type="button"
                  >
                    <i class="fa-solid fa-clock-rotate-left fa-2xl me-4" style={{color: "#ffffff"}}></i>
