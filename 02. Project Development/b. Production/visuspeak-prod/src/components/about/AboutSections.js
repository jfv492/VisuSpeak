    ...
    <div>
      ...
      <div class="row about-us-sections align-items-center">
        ...
        <div class="col-sm-8 lead">
          ...
          VisuSpeak is an application with several features that aim to make
          communication between ASL speakers and English speakers more seamless,
          meaningful, and natural. With customizable chatting interactions,
          options to save and view different conversations, and a resource
          section to allow you to expand upon your American Sign Language
          knowledge, conversing using older, more traditional methods like pen
          and paper is a thing of the past. See below how VisuSpeak can increase
          accessibility within your customer-facing interactions in a fun, new,
          and engaging way!
        </div>
      </div>
    </div>
